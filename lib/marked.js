...
(function (global, factory) {
  ...
  inline$1.reflink = edit(inline$1.reflink).replace('label', inline$1._label).replace('ref', block$1._label).getRegex();
  inline$1.nolink = edit(inline$1.nolink).replace('ref', block$1._label).getRegex();
